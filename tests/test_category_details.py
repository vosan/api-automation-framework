...
def test_category_details() -> None:
    ...
    """
    # Initialize client and assertions
    ...
    # Perform validations
    assertions.assert_category_name(response, "Carbon credits")
    assertions.assert_can_relist(response, True)
    assertions.assert_gallery_promotion_description_contains(response, "Good position in category")
